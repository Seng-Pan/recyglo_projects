...
import bgImage from '../assets/Green4.jpg'
    ...
    <div className="min-h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${bgImage})` }}>
      ...
      <section className="flex flex-col justify-start">
        <div className="content min-w-lg mx-8 md:mx-20 my-12">
          <div className="info">
            <h2 className="text-5xl md:text-5xl font-extrabold text-800 uppercase opacity-80 leading-tight" style={{color:'#2A5A6B'}}>
            ...
            <a href="#" className="text-white font-bold bg-800 hover:bg-700 uppercase px-5 py-2 rounded transition" style={{background:'#2D6274',hover:{background:'#2C7289'}}} onClick={clickSignIn} >
              Sign in
            </a>
          </div>
        </div>
